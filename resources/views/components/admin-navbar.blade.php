<nav class="flex justify-between items-center px-0 py-2.5" x-data="{ isOpen: false }">
    ...
    <div>
        <a class="text-[#4D869C] no-underline text-xl px-5 py-0 hover:text-black hover:trasition[-0.3s]" href="/admin/dashboard">Dashboard</a>
        <a class="text-[#4D869C] no-underline text-xl px-5 py-0 hover:text-black hover:trasition[-0.3s]" href="/admin/products">Product</a>
